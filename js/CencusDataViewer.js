    ...
    },
    {
        ...
        $(document).ready(function() {
            ...
            censusData.forEach(item => {
                $('#filenameSelect').append(`<option value="${item.filename}">${item.filename}</option>`);
                $('#descriptionSelect').append(`<option value="${item.filename}">${item.description}</option>`);
            });
            ...
            $('#filenameSelect').change(function() {
                ...
                if (selectedFilename) {
                    ...
                    $('#descriptionSelect').val(selectedFilename);
            ...
            $('#descriptionSelect').change(function() {
                ...
                if (selectedFilename) {
                    ...
                    $('#filenameSelect').val(selectedFilename);
                    displayData(selectedFilename);
                } else {
                    $('#dataDisplay').hide();
                }
        ...
        function displayData(filename) {
            ...
            // Display basic info
            $('#selectedFilename').text(selectedItem.filename);
            $('#selectedDescription').text(selectedItem.description);
            $('#selectedYear').text(selectedItem.year);
            $('#fileLink').attr('href', selectedItem.file).text(selectedItem.file);
            ...
            const dataTypesTable = $('#dataTypesTable tbody');
            dataTypesTable.empty();
            selectedItem.data_types.forEach(dataType => {
                dataTypesTable.append(`
                    <tr>
                        <td>${dataType.name}</td>
                        <td>${dataType.type}</td>
                    </tr>
